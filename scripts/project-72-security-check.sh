...
# Checked-in examples must never contain floating deployment versions or obvious credential material.
...
# Private IMS policy must be explicit in the checked-in boundary.
